...
export const GUIDES = [
  ...
  {
    slug: "house-cleaning-fumigation-prices-nigeria",
    title: "House Cleaning & Fumigation Prices in Nigeria (2026)",
    description:
      "What deep cleaning, post-construction cleaning and fumigation cost in Nigeria in 2026 — plus how to hire a cleaning service that actually does a thorough job.",
    trade: "Cleaning",
    updated: "June 2026",
    readMins: 5,
    body: [
      { type: "p", text: "Whether you're moving into a new flat, recovering from building work, or just want your home properly done, a good cleaning service saves you a full weekend of stress. Here's what cleaning and fumigation realistically cost in Nigeria in 2026." },
      { type: "h2", text: "Typical cleaning prices (2026)" },
      { type: "price", rows: [
        ["Regular cleaning (per visit)", "₦8,000 – ₦20,000"],
        ["Deep cleaning (1-bed flat)", "₦20,000 – ₦45,000"],
        ["Deep cleaning (2–3 bedroom)", "₦35,000 – ₦90,000"],
        ["Post-construction cleaning", "₦50,000 – ₦200,000+"],
        ["Fumigation / pest control (flat)", "₦10,000 – ₦30,000"],
      ] },
      { type: "h2", text: "How to hire a thorough cleaner" },
      { type: "ul", items: [
        "Agree exactly what's included — windows, kitchen, wardrobes, bathrooms.",
        "Confirm whether they bring their own materials and equipment.",
        "For fumigation, ask which chemicals are used and how long to stay out.",
        "Check reviews or photos of past jobs before booking.",
      ] },
      { type: "tip", text: "Book deep cleaning and fumigation together when moving in — it's cheaper as one visit and you start fresh in a clean, pest-free home." },
      { type: "h2", text: "Find a cleaning service near you" },
      { type: "p", text: "Compare cleaners and fumigation services on NaijaArtisans by reviews and price, and post your job free to get quotes from providers in your city." },
    ],
  },
  {
    slug: "catering-small-chops-prices-nigeria",
    title: "Catering & Small Chops Prices in Nigeria (2026)",
    description:
      "Party catering, small chops and cooler-of-rice prices in Nigeria for 2026 — plus how to choose a caterer who delivers great food, on time, for your event.",
    trade: "Catering & Cooking",
    updated: "June 2026",
    readMins: 5,
    body: [
      { type: "p", text: "Food can make or break an owambe. Whether it's a birthday, wedding or office event, knowing catering prices helps you budget properly and avoid both overpaying and disappointing your guests. Here's the 2026 picture." },
      { type: "h2", text: "Typical catering prices (2026)" },
      { type: "price", rows: [
        ["Jollof / fried rice (per plate)", "₦1,500 – ₦4,000"],
        ["Small chops (per pack)", "₦1,500 – ₦3,500"],
        ["Full catering (per guest)", "₦3,000 – ₦8,000"],
        ["Large cooler of rice", "₦40,000 – ₦90,000"],
        ["Grilled chicken / turkey (per portion)", "₦2,000 – ₦5,000"],
      ] },
      { type: "h2", text: "How to choose a caterer who delivers" },
      { type: "ul", items: [
        "Always taste the food before booking for a big event.",
        "Confirm the final headcount and price per head in writing.",
        "Ask what's included — plates, servers, warmers, delivery.",
        "Check reviews and photos from real past events.",
      ] },
      { type: "tip", text: "Book early for peak seasons (December, wedding season). Good caterers get fully booked weeks ahead, and last-minute bookings cost more." },
      { type: "h2", text: "Find a caterer near you" },
      { type: "p", text: "Browse caterers and cooks on NaijaArtisans by city, see their menus and reviews, and post your event free to receive quotes." },
    ],
  },
  {
    slug: "pop-ceiling-cost-nigeria",
    title: "POP Ceiling Cost in Nigeria: A 2026 Price Guide",
    description:
      "How much POP ceiling and screeding cost in Nigeria in 2026 — per room and per design — plus how to get a clean, crack-free finish.",
    trade: "POP & Ceiling",
    updated: "June 2026",
    readMins: 5,
    body: [
      { type: "p", text: "POP ceilings turn a plain room into a finished, modern space. But prices swing a lot depending on design complexity and materials, so it pays to understand what you're paying for before you commit." },
      { type: "h2", text: "Typical POP prices (2026)" },
      { type: "price", rows: [
        ["POP ceiling (per m²)", "₦2,500 – ₦5,000"],
        ["Simple room (flat POP)", "₦40,000 – ₦120,000"],
        ["Parlour / detailed design", "₦150,000 – ₦500,000+"],
        ["Screeding (per room, extra)", "₦10,000 – ₦30,000"],
        ["Cornice only (per length)", "₦1,500 – ₦4,000"],
      ] },
      { type: "h2", text: "Get a clean, lasting finish" },
      { type: "ul", items: [
        "Ask whether the quote is labour-only or includes materials.",
        "Confirm the design in a photo or drawing before work starts.",
        "Good POP needs proper drying time — don't rush painting over it.",
        "Check past ceilings for straight lines and no visible cracks.",
      ] },
      { type: "tip", text: "Cracks usually come from poor materials or rushing the job. Insist on quality boards and enough curing time before painting." },
      { type: "h2", text: "Find a POP specialist near you" },
      { type: "p", text: "Compare POP and ceiling specialists on NaijaArtisans by reviews and past work, and post your job free to get quotes in your city." },
    ],
  },
  {
    slug: "solar-inverter-installation-cost-nigeria",
    title: "Solar & Inverter Installation Cost in Nigeria (2026)",
    description:
      "Real 2026 prices for inverter and solar systems in Nigeria — from a small backup inverter to a full solar home — plus how to size your system correctly.",
    trade: "Solar & Inverter Installation",
    updated: "June 2026",
    readMins: 6,
    body: [
      { type: "p", text: "With the cost of fuel and unreliable power, more Nigerian homes are switching to inverters and solar. But it's a big investment with a wide price range, so getting the sizing and installer right matters. Here's what to expect in 2026." },
      { type: "h2", text: "Typical system prices (2026)" },
      { type: "price", rows: [
        ["1kVA inverter + battery (backup)", "₦250,000 – ₦450,000"],
        ["2.5kVA inverter system", "₦600,000 – ₦1,200,000"],
        ["3.5kVA + solar panels (basic home)", "₦1,500,000 – ₦3,000,000"],
        ["5kVA full solar system", "₦3,000,000 – ₦6,000,000+"],
        ["Inverter servicing / repair", "₦10,000 – ₦40,000"],
      ] },
      { type: "h2", text: "Get the sizing right" },
      { type: "ul", items: [
        "Ask the installer to do a load audit — what you actually run and for how long.",
        "Understand battery types: tubular is cheaper; lithium lasts longer and costs more.",
        "Confirm the warranty on the inverter, batteries and panels separately.",
        "Beware of undersized quotes — a system too small for your load fails fast.",
      ] },
      { type: "tip", text: "The cheapest quote is rarely the best here. Undersized systems and low-quality batteries cost far more in replacements within a year or two." },
      { type: "h2", text: "Find a solar installer near you" },
      { type: "p", text: "Compare solar and inverter installers on NaijaArtisans by reviews and past installations, and post your job free to get properly-sized quotes." },
    ],
  },
  {
    slug: "cctv-installation-cost-nigeria",
    title: "CCTV Installation Cost in Nigeria (2026 Guide)",
    description:
      "What CCTV installation costs in Nigeria in 2026 — camera kits, per-camera pricing and maintenance — plus what to look for in a good security setup.",
    trade: "CCTV & Security Systems",
    updated: "June 2026",
    readMins: 5,
    body: [
      { type: "p", text: "CCTV gives peace of mind for homes and businesses, but quality and price vary enormously. Here's a clear 2026 guide to what installation costs and how to get a system that actually protects you." },
      { type: "h2", text: "Typical CCTV prices (2026)" },
      { type: "price", rows: [
        ["4-camera kit + installation", "₦150,000 – ₦350,000"],
        ["8-camera system + installation", "₦300,000 – ₦700,000"],
        ["Per extra camera", "₦25,000 – ₦60,000"],
        ["Maintenance / repair visit", "₦10,000 – ₦30,000"],
        ["Remote-viewing setup", "₦10,000 – ₦25,000"],
      ] },
      { type: "h2", text: "What to look for in a good setup" },
      { type: "ul", items: [
        "Camera resolution — 2MP is a sensible minimum; higher for entrances.",
        "Proper night vision, since most incidents happen after dark.",
        "How many days of footage the storage (DVR/NVR) keeps.",
        "Remote viewing on your phone, set up and tested before they leave.",
      ] },
      { type: "tip", text: "Placement matters more than camera count. A good installer covers entry points and blind spots — ask them to walk the plan with you first." },
      { type: "h2", text: "Find a CCTV installer near you" },
